...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2026/04/18 14:42:32 by vshanmug          #+#    #+#              #
#    Updated: 2026/04/18 14:42:32 by vshanmug         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PART1 = ft_tolower.c ft_toupper.c ft_isprint.c ft_isascii.c ft_isalnum.c \
		...
		ft_calloc.c ft_strdup.c ft_memcpy.c ft_strchr.c \
...
PART3 = ft_lstnew.c ft_lstadd_front.c ft_lstsize.c ft_lstlast.c ft_lstadd_back.c \

...
//ft_strdup used to duplicate the buffer into newly allocated memory 
//and return it
//ft_fill_itoa is a recurisve function that fills the buffer 
//with the characters of the integer n and updates the index of the buffer 
//using b_idx pointer
